                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                @endif
                                <h4 class="card-title mb-1">{{__('labels.login.forgot-message')}}</h4>
                                <p class="card-text mb-2">{{__('labels.login.forgot-text')}}</p>

                                <form class="auth-forgot-password-form mt-2" action="{{route('admin.forgot.password.send')}}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label for="forgot-password-email" class="form-label">{{__('labels.email')}}</label>
