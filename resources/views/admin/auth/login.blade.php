                            ...
                            <div class="card-body">
                                ...
                                <form class="auth-login-form mt-2" action="{{route('admin.login')}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="login-email" class="form-label">{{__('labels.email')}}</label>
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between">
                                            <label for="login-password">{{__('labels.password')}}</label>
                                            <a href="{{route('admin.forgot.password.email')}}">
                                                <small>{{__('labels.login.forgot-password')}}</small>
                                            </a>
                                        </div>
                                ...
                                <p class="text-center mt-2">
                                    <span>{{__('labels.login.forgot-password')}}</span>
                                    <a href="{{route('admin.forgot.password.email')}}">
