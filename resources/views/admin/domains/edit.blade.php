                        ...
                        <div class="card">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="form form-horizontal" method="post" action="{{route('admin.domains.update', $domain->id)}}">
                                            @csrf
                                            @method('put')
                                            <div class="row">
                                                <div class="col-12 mb-2">
                                                    <x-form.input
                                                        ...
                                                        :value="$domain->name" {{-- optional default=null --}}
                                                    />

                                                    <x-form.textarea
                                                        name="description" {{-- required --}}
                                                        :is-required="true" {{-- optional default=false --}}
                                                        :value="$domain->description" {{-- optional default=null --}}
                                                    />
