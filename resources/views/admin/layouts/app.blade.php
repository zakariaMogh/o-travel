...
<head>
    ...
    <meta name="keywords" content="Humeato, Vuexy admin template, dashboard template, flat admin template, responsive admin template, web app">
    <meta name="author" content="Humeato">
