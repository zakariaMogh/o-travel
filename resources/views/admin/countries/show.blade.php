...
@section('title',trans_choice('labels.county',2))
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="{{route('admin.counties.index')}}">{{__('labels.list',['name'=> trans_choice('labels.county',2)])}}</a>
                                    </li>
                                        ...
                                        <div
                                            ...
                                            <div class="mt-md-0 mt-2">
                                                <h4 class="invoice-title">
                                                    {{__('labels.name')}} :
                                                    <span class="invoice-number">{{$county->name}}</span>
                                                </h4>
